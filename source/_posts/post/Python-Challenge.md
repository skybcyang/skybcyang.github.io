...
{% asset_img python_challenge_1.png %}
...
{% asset_img python_challenge_2.png %}
...
{% asset_img python_challenge_5.png %}
...
# 4
{% asset_img python_challenge_13.png %}
没有任何提示
...
{% asset_img python_challenge_14.png %}

这里没有使用正则匹配，怕他又玩什么幺蛾子，就这样，我运行了一会觉得不对劲，于是加了输出。

{% asset_img python_challenge_15.png %}
...
{% asset_img python_challenge_16.png %}

让我们读出图片中的山（应该是英文吧）查了一下源代码后发现

{% asset_img python_challenge_17.png %}
...
{% asset_img python_challenge_18.png %}

Print 之后发现返回的是一个列表

{% asset_img python_challenge_19.png %}
...
{% asset_img python_challenge_20.png %}

结果如下，哈哈哈，下一关走起！
{% asset_img python_challenge_21.png %}
